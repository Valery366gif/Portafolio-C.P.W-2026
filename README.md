...
```
Portafolio-C.P.W-2026/
├── README.md                      ← este archivo
├── .gitignore
├── recursos/                      ← capturas de pantalla y material de apoyo
├── unidad-01-control-versiones/   ← Git y GitHub
├── unidad-02-html/                ← Etiquetas y atributos HTML
├── unidad-03-css/                 ← Codificación de hojas de estilo
├── unidad-04-responsivo/          ← Páginas web responsivas
└── unidad-05-framework/           ← Frameworks y librerías
```
...
|  S16   | Flexbox                    |  Trabajamos con propiedades de flexbox para posicionar cajas y sus elementos           | [ver](unidad-03-css/sitio-demo/galeria.html) | [ver](recursos/S.16-Flexbox.png) |
|  S17   | CSS Grid                   |  Trabajamos grid template           | [ver](unidad-03-css/sitio-demo/galeria.html) | [ver](recursos/S17-Grid.png) |
|  S18   | Componentes estilizados    |  Agrego tarjetascon interactividad, estilizamos formularios y tablas            | [ver](unidad-03-css/sitio-demo/galeria.html) | [ver](recursos/S18-Tajetas-tablas-formularios.png) |
|  S19   | Animaciones y filtros      |Trabajo con transiciones, trasformaciones, animaciones y filtros          | [ver](unidad-03-css/sitio-demo/galeria.html) | [ver](recursos/S-19-Animaciones.png) |
...
|  S25   | Menú responsivo e impresión     | Menú hamburgueza i media print| [ver](unidad-04-responsivo/luz-clara/index.html) | [ver](recursos/S25-media%20print.png) |
|  S26   | Imágenes y video adaptativos    |Picture y el source  para imagenes adaptadas segun e ltamaño | [ver](unidad-04-responsivo/luz-clara/galeria.html) | [ver](recursos/s25-picture.png) |
|  S27   | Patrones de diseño adaptativo I | 5 patrones de diseño adaptativo| [ver](unidad-04-responsivo/luz-clara/index.html) | [ver](recursos/s27-patrones1.png) |
|  S28   | Patrones II y repaso            |  Off canvas patrón de diseño| [ver](unidad-04-responsivo/luz-clara/galeria.html) | [ver](recursos/s27-patrones.png) |
...
<!--
  ─────────────────────────────────────────────────────────────────────
  SOBRE LOS ENLACES DE LA COLUMNA "TRABAJO"

  Los enlaces de arriba apuntan a la CARPETA de cada unidad. Eso funciona
  bien dentro de GitHub (muestra el listado de archivos), pero en el sitio
  publicado con GitHub Pages una carpeta sin index.html da error 404.

  Conforme avance el módulo, conviene cambiarlos por la ruta del archivo
  concreto de esa sesión. Por ejemplo:

      [ver](unidad-03-css/s16-flexbox/index.html)

  Así el enlace funciona en los dos lugares: en GitHub y en el sitio.
  ─────────────────────────────────────────────────────────────────────
-->
